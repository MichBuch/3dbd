            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                {view === 'initial' && (
                    <div className="p-12 text-center">
                        <h1 className="text-4xl font-bold text-white mb-4">Welcome to 3dBd</h1>
                        <p className="text-gray-400 mb-8">Choose how you'd like to continue</p>

                        <div className="flex flex-col gap-4 max-w-md mx-auto">
                            <button
                                onClick={() => setView('pricing')}
                                className="bg-gradient-to-r from-neonBlue to-neonPink text-black font-bold py-4 px-8 rounded-lg text-lg hover:opacity-90 transition-opacity"
                            >
                                Sign Up
                            </button>
                            <button
                                onClick={() => setView('login')}
                                className="bg-white/10 border border-white/20 text-white font-bold py-4 px-8 rounded-lg text-lg hover:bg-white/20 transition-colors"
                            >
                                Log In
                            </button>
                        </div>
                    ...
                    <div className="p-12">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-white/10 rounded-2xl p-8">
                                ...
                                <p className="text-gray-400 mb-6">Perfect for learning the ropes. Play against the AI and track your local progress.</p>

                                <div className="space-y-3 mb-8">
                                    <div className="flex items-center gap-2 text-gray-300">
                                        <span className="text-green-400">✓</span>
                                        <span>Play vs AI (Easy-Hard)</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-gray-300">
                                        <span className="text-green-400">✓</span>
                            ...
                            <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-neonBlue rounded-2xl p-8">
                                ...
                                <h3 className="text-2xl font-bold text-white mb-2">Pro Competitor</h3>
                                <div className="text-5xl font-bold text-white mb-1">
                                    $9.99
                                    <span className="text-lg text-gray-400">/year</span>
                                </div>
                                <p className="text-gray-400 mb-6">Unlock the full SaaS experience. Challenge real players worldwide and climb the ranks.</p>
                                ...
                                <div className="space-y-3 mb-8">
                                    ...
                                    <div className="flex items-center gap-2 text-gray-300">
                                        <span className="text-neonBlue">✓</span>
                                        <span className="font-semibold">Global Leaderboards</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-gray-300">
                                        <span className="text-neonBlue">✓</span>
                                ...
                                <button
                                    ...
                                    className="w-full bg-gradient-to-r from-neonBlue to-neonPink text-black font-bold py-3 rounded-lg hover:opacity-90 transition-opacity"
                                >
                                    Upgrade Now
                                </button>
                            </div>
                    ...
                    <div className="p-8 max-h-[80vh] overflow-y-auto">
                        ...
                        <div className="space-y-3 mb-6">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-[#1877F2] text-white font-semibold py-3 px-4 rounded-lg hover:bg-[#166FE5] transition-colors flex items-center justify-center gap-3"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <form onSubmit={handleEmailSignIn} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-white text-black font-bold py-4 rounded-lg hover:bg-gray-200 transition-colors disabled:opacity-50 shadow-lg border-2 border-white text-lg"
                            >
                    ...
                    <div className="p-12">
                        ...
                        <form onSubmit={handleEmailSignIn} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-white text-black font-bold py-3 rounded-lg hover:bg-gray-200 transition-colors disabled:opacity-50 shadow-lg border-2 border-white"
                            >
